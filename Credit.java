...
public class Credit extends HttpServlet{
	...
	public void service(HttpServletRequest req , HttpServletResponse res)throws ServletException,IOException
	{
		...
		long credit =Long.parseLong(req.getParameter("ammount"));
		...
		try
		{
			...
			PreparedStatement ps0 = con.prepareStatement("insert into Credit values(?,?,?)");
			ps0.setString(1,accountno);
			ps0.setLong(2,credit);
			...
			while(rs.next())
			{
				...
				long newBalance = credit+ammount;
				Statement s1 = con.createStatement();
				s1.executeUpdate("update accountdata set balance="+newBalance+" where accountno='"+accountno+"'");
				out.println("<br><b style='color:green;background:yellow;'>Credited ammount</b> : " +credit);
				out.println("<br><b style='color:green;background:yellow;'>Total Balance is</b> : " +newBalance);
			}
