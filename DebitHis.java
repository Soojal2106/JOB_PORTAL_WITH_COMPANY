...
public class DebitHis extends HttpServlet{
...
out.print("<table border='0' style='border-collapse:collapse'>");
			...
			ResultSet rs = s.executeQuery("select * from debit");
			while(rs.next())
			{	
				
     				out.print("<tr><td>"+sno+"</td><td>"+rs.getString(1)+"</td><td>"+"<b style='color:red'>- </b>"+"<b style='color:red'>"+rs.getString(2)+"</b>"+"</td><td>"+rs.getDate(3)+"</td></tr>");
